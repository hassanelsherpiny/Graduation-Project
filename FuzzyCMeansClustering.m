function lesionSegmented = FuzzyCMeansClustering( imgPath )
    ...
    IMMM=uint8(IMMM);
    lesionSegmented = imcomplement(im2bw(IMMM, 0.5));
    
    %Find Lesion & Border
    %whiteArea = find(lesionSegmented == 0)
    
    % You should next eliminate the corner borders.
